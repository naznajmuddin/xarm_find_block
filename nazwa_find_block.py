...
# First Position
if arm.error_code == 0 and not params['quit']:
    if arm.set_servo_angle(angle=[135, 0, -120, 0, 120, 45],
                           speed=params['angle_speed'],
                           mvacc=params['angle_acc'], wait=True) != 0:
        params['quit'] = True
...
mask = cv2.inRange(hsvFrameConvert_1, lower_yellow, upper_yellow)
...
# 2nd Position
if arm.error_code == 0 and not params['quit']:
    if arm.set_servo_angle(angle=[25, 0, -110, 0, 105, 25],
                           speed=params['angle_speed'],
                           mvacc=params['angle_acc'], wait=True) != 0:
        params['quit'] = True
# RealTimeCapturing
...
# 3rd Position
if arm.error_code == 0 and not params['quit']:
    if arm.set_servo_angle(angle=[-45, 0, -120, 0, 120, 45],
                           speed=params['angle_speed'],
                           mvacc=params['angle_acc'], wait=True) != 0:
        params['quit'] = True
# RealTimeCapturing
...
# 4th Position
if arm.error_code == 0 and not params['quit']:
    if arm.set_servo_angle(angle=[-150.0, 0.0, -110.0, 0.0, 105.0, 30.0],
                           speed=params['angle_speed'],
                           mvacc=params['angle_acc'], wait=True) != 0:
        params['quit'] = True
# RealTimeCapturing
